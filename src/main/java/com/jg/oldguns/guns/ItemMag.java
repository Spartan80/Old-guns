...
public class ItemMag extends Item {
	...
	public interface IFactory {
		Bullet create(LivingEntity entity, Level p_create_2_);
	}

	public ItemMag(Item.Properties prop, String gunid, int maxammo, String acceptedSize, int metal, boolean isIron, float weight, IFactory test) {
		super(prop);
		this.gunId = gunid;
	...
	public InteractionResultHolder<ItemStack> use(Level p_77659_1_, Player p_77659_2_, InteractionHand p_77659_3_) {
		if (!p_77659_1_.isClientSide) {
			NetworkHooks.openGui((ServerPlayer) p_77659_2_, new SimpleMenuProvider(
					(id, pi, cplayer) -> new MagContainer(id, pi), new TranslatableComponent("gui.oldguns.mag_gui")));
		}
	...
	public Bullet getProjectile(Player player, Level world) {
