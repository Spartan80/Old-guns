...
public class Ak74u extends ItemGun{

	public Ak74u(Properties prop, RegistryObject<Item> mag) {
		super(prop, mag);
	...
	public Item getBarrel() {
		// TODO Auto-generated method stub
		return ItemRegistries.Ak74uBarrel.get();
	}

	@Override
	public Item getBody() {
		// TODO Auto-generated method stub
		return ItemRegistries.Ak74uBody.get();
	}

	@Override
	public Item getStock() {
		// TODO Auto-generated method stub
		return ItemRegistries.Ak74uStock.get();
	}
