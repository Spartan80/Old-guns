...
public class BlockRegistries {
	...
	public static RegistryObject<Block> Gun_parts_block = BLOCKS.register("gun_parts_block",
			() -> new GunPartsBlock(BlockBehaviour.Properties.of(Material.HEAVY_METAL).strength(2.0F, 3.0F).strength(2)
					.sound(SoundType.METAL)));

	public static RegistryObject<Block> Gun_ammo_block = BLOCKS.register("gun_ammo_block", () -> new GunAmmoBlock(
			BlockBehaviour.Properties.of(Material.HEAVY_METAL).strength(2.0F, 3.0F).sound(SoundType.METAL)));
