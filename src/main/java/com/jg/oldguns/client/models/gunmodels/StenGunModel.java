...
public class StenGunModel extends GunModel {
	...
	public StenGunModel(ClientHandler client) {
		...
		look = new Animation("lookAnim", "oldguns:sten", AnimationType.LOOK)
				...
				.end();
		kickback = new Animation("kickbackAnim", "oldguns:sten", AnimationType.MELEEHIT)
				...
				.end();
		getOutMag = new Animation("getOutMagAnim", "oldguns:sten", AnimationType.RELOAD)
				...
				.rotate(parts[6], 0.0f, 0.0f, 0.0f)
				.end();
		reloadNoMag = new Animation("reloadNoMagAnim", "oldguns:sten", AnimationType.RELOAD)
				.startKeyframe(12)
				.translate(parts[1], 0.0f, 0.0f, 0.0f)
				.translate(parts[7], -0.07999999f, -0.67999965f, 0.0f)
				.translate(parts[6], 0.0f, 0.0f, 0.0f)
				...
				.rotate(parts[6], 0.0f, 0.0f, 0.0f)
				.end();
		reloadMagByMag = new Animation("reloadMagByMagAnim", "oldguns:sten", AnimationType.RELOAD)
				.startKeyframe(12, "easeOutBack")
				.translate(parts[1], 0.0f, 0.0f, 0.0f)
				.translate(parts[7], -0.07999999f, 0.0f, 0.0f)
				.translate(parts[6], 0.0f, 0.0f, 0.0f)
	...
	public Vector3f getMuzzleFlashPosition() {
		return new Vector3f(-0.1f, 0.23f, -0.52f);
	}
