...
public class ScorpionGunModel extends GunModel {
	...
	public ScorpionGunModel(ClientHandler client) {
		...
		look = new Animation("lookAnim", "oldguns:scorpion", AnimationType.LOOK)
				...
				.end();
		kickback = new Animation("kickbackAnim", "oldguns:scorpion", AnimationType.MELEEHIT)
				...
				.end();
		getOutMag = new Animation("getOutMagAnim", "oldguns:scorpion", AnimationType.RELOAD)
				.startKeyframe(12)
				...
				.rotate(parts[1], 0.0f, 0.0f, 0.0f)
				.end();
		reloadNoMag = new Animation("reloadNoMagAnim", "oldguns:scorpion", AnimationType.RELOAD)
				.startKeyframe(12, "easeInQuint")
				.translate(parts[7], 0.0f, -0.67999965f, 0.0f)
				.translate(parts[6], 0.0f, 0.0f, 0.0f)
				.translate(parts[5], 0.3799999f, 0.21000002f, 0.0f)
				...
				.rotate(parts[1], 0.0f, 0.0f, 0.0f)
				.end();
		reloadMagByMag = new Animation("reloadMagByMagAnim", "oldguns:scorpion", AnimationType.RELOAD)
				.startKeyframe(12)
				.translate(parts[1], 0.02f, -0.11999998f, 0.24000004f)
				.translate(parts[7], 0.0f, 0.0f, 0.0f)
				.translate(parts[6], 0.0f, 0.0f, 0.0f)
	...
	public Vector3f getMuzzleFlashPosition() {
		return new Vector3f(0.04f, 0.14f, -0.7f);
	}
