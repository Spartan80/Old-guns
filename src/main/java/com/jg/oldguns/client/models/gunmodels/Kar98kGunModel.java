...
public class Kar98kGunModel extends GunModel {
	...
	public Kar98kGunModel(ClientHandler client) {
		...
		look = new Animation("lookAnim", "oldguns:kar98k", AnimationType.LOOK)
				.startKeyframe(12)
		...
		reload = new RepetitiveAnimation("reloadAnim", "oldguns:kar98k", AnimationType.RELOAD)
				.startKeyframe(12)
		...
		kickback = new Animation("kickbackAnim", "oldguns:kar98k", AnimationType.MELEEHIT)
		...
		shootAnim = new Animation("shootAnim", "oldguns:kar98k", AnimationType.SHOOT)
				.startKeyframe(12, "easeInSine")
				.translate(parts[5], 0.0f, 0.0f, 0.0f)
