...
public class ThompsonGunModel extends GunModel {
	...
	public ThompsonGunModel(ClientHandler client) {
		...
		look = new Animation("lookAnim", "oldguns:thompson", AnimationType.LOOK)
				...
				.end();
		kickback = new Animation("kickbackAnim", "oldguns:thompson", AnimationType.MELEEHIT)
				...
				.end();
		getOutMag = new Animation("getOutMagAnim", "oldguns:thompson", AnimationType.RELOAD)
				.startKeyframe(12)
				.translate(parts[6], 0.0f, 0.0f, 0.0f)
				...
				.rotate(parts[5], 0.0f, 0.0f, 0.0f)
				.end();
		reloadNoMag = new Animation("reloadNoMagAnim", "oldguns:thompson", AnimationType.RELOAD)
				.startKeyframe(12, "easeInSine")
				.translate(parts[6], 0.0f, 0.0f, 0.0f)
				.translate(parts[7], 0.0f, -0.77999955f, 0.0f)
				.translate(parts[5], 0.31999996f, 0.11999998f, 0.0f)
				...
				.rotate(parts[5], 0.0f, 0.0f, 0.0f)
				.end();
		reloadMagByMag = new Animation("reloadMagByMag", "oldguns:thompson", AnimationType.RELOAD)
				.startKeyframe(12)
				.translate(parts[7], 0.0f, 0.0f, 0.0f)
				.translate(parts[5], 0.31999996f, 0.11999998f, 0.0f)
				.translate(parts[6], 0.0f, 0.0f, 0.0f)
	...
	public Vector3f getMuzzleFlashPosition() {
		return new Vector3f(0.3f, 0.22f, -1.22f);
	}
