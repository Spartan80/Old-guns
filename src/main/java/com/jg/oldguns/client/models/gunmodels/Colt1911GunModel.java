...
public class Colt1911GunModel extends GunModel {
	...
	public Colt1911GunModel(ClientHandler client) {
		...
		shootAnim = new Animation("shootAnim", "oldguns:colt1911", AnimationType.SHOOT)
				.startKeyframe(3)
				...
				.end();
		look = new Animation("lookAnim", "oldguns:colt1911", AnimationType.LOOK)
				...
				.end();
		kickback = new Animation("kickbackAnim", "oldguns:colt1911", AnimationType.MELEEHIT)
				...
				.rotate(parts[6], 0.0f, 0.0f, 0.0f)
				.end();
		getOutMag = new Animation("getOutMagAnim", "oldguns:colt1911", AnimationType.RELOAD)
				...
				.rotate(parts[6], 0.0f, 0.0f, 0.0f)
				.end();
		reloadNoMag = new Animation("reloadNoMagAnim", "oldguns:colt1911", AnimationType.RELOAD)
				...
				.rotate(parts[6], 0.0f, 0.0f, 0.0f)
				.end();
		reloadMagByMagEeasterEgg = new Animation("reloadMagByMagAnim", "oldguns:colt1911", AnimationType.RELOAD)
				.startKeyframe(12, "easeInQuint")
				...
				.rotate(parts[6], 0.0f, 0.0f, 0.0f)
				.end();
		reloadMagByMag = new Animation("reloadMagByMagAnim", "oldguns:colt1911", AnimationType.RELOAD)
				.startKeyframe(12, "easeInCubic")
				.translate(parts[1], -0.3799999f, 0.0f, 0.0f)
				.translate(parts[7], 0.0f, 0.0f, 0.0f)
				.translate(parts[8], 0.0f, 0.0f, 0.0f)
	...
	public Vector3f getMuzzleFlashPosition() {
		// 0.3f 0.0f -1.7799987f
		return new Vector3f(0.3f, 0.0f, -1.7799987f);
	}
