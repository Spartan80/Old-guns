...
public class Mp40GunModel extends GunModel {
	...
	public Mp40GunModel(ClientHandler client) {
		...
		shootAnim = new Animation("shootAnim", "oldguns:mp40", AnimationType.SHOOT)
				.startKeyframe(1)
				.translate(parts[3], 0.0f, -0.010000001f, 0.33000004f)
				.startKeyframe(1)
				.translate(parts[3], 0.0f, 0.0f, 0.0f)
				.end();
		look = new Animation("lookAnim", "oldguns:mp40", AnimationType.LOOK)
				...
				.end();
		kickback = new Animation("kickbackAnim", "oldguns:mp40", AnimationType.MELEEHIT)
				...
				.end();
		getOutMag = new Animation("getOutMagAnim", "oldguns:mp40", AnimationType.RELOAD)
				.startKeyframe(12)
				...
				.translate(parts[7], 0.0f, 0.0f, 0.0f)
				.end();
		reloadNoMag = new Animation("reloadNoMagAnim", "oldguns:mp40", AnimationType.RELOAD)
				...
				.rotate(parts[6], 0.0f, 0.0f, 0.0f)
				.end();
		reloadMagByMag = new Animation("reloadMagByMagAnim", "oldguns:mp40", AnimationType.RELOAD)
				.startKeyframe(12, "easeInQuint")
				.translate(parts[7], 0.0f, 0.0f, 0.0f)
				.translate(parts[6], 0.0f, -0.11999998f, 0.0f)
				.translate(parts[3], 0.0f, 0.0f, 0.0f)
	...
	public Vector3f getMuzzleFlashPosition() {
		return new Vector3f(0.04f, 0.23f, -1.25f);
	}
