...
public class GalilGunModel extends GunModel {
	...
	public GalilGunModel(ClientHandler client) {
		...
		kickback = new Animation("kickbackAnim", "oldguns:galil")
				...
				.end();
		kickback = new Animation("kickbackAnim", "oldguns:galil")
				.startKeyframe(8, "easeInSine")
				.translate(parts[1], -0.5399998f, 0.0f, 0.47999984f)
				.translate(parts[6], 0.0f, 0.0f, 0.0f)
				.translate(parts[5], 0.0f, 0.0f, 0.0f)
				.translate(parts[0], 1.5499989f, 0.24000005f, 0.23000002f)
				.translate(parts[2], 0.0f, 0.0f, 0.0f)
				.rotate(parts[6], 0.0f, 0.0f, 0.0f)
				.rotate(parts[5], 0.0f, 0.0f, 0.0f)
				.rotate(parts[0], -0.6457719f, 0.9250249f, 0.80285174f)
				.rotate(parts[2], 0.0f, 0.9250249f, 0.0f)
				.startKeyframe(6)
				.translate(parts[1], -0.5399998f, 0.0f, 0.47999984f)
				.translate(parts[6], 0.0f, 0.0f, 0.0f)
				.translate(parts[5], 0.0f, 0.0f, 0.0f)
				...
				.translate(parts[1], -0.5399998f, 0.0f, 0.47999984f)
				.translate(parts[6], 0.0f, 0.0f, 0.0f)
				.translate(parts[5], 0.0f, 0.0f, 0.40999988f)
				.translate(parts[0], 1.5499989f, 0.24000005f, 0.23000002f)
				.translate(parts[2], 0.0f, 0.0f, 0.0f)
				.rotate(parts[6], 0.0f, 0.0f, 0.0f)
				.rotate(parts[5], 0.0f, 0.0f, 0.0f)
				.rotate(parts[0], -0.6457719f, 0.9250249f, 0.80285174f)
				.rotate(parts[2], 0.0f, 0.9250249f, 0.0f)
				.startKeyframe(6, "easeInOutBounce")
				.translate(parts[1], -0.5399998f, 0.0f, 0.47999984f)
				.translate(parts[6], 0.0f, 0.0f, 0.0f)
				.translate(parts[5], 0.0f, 0.0f, -0.30999997f)
				.translate(parts[0], 1.5499989f, 0.24000005f, 0.23000002f)
				.translate(parts[2], 0.0f, 0.0f, 0.0f)
				.rotate(parts[6], 0.0f, 0.0f, 0.0f)
				.rotate(parts[5], 0.0f, 0.0f, 0.0f)
