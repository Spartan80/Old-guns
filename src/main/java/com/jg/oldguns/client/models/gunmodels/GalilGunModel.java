...
public class GalilGunModel extends GunModel {
	...
	public GalilGunModel(ClientHandler client) {
		...
		look = new Animation("lookAnim", "oldguns:galil", AnimationType.LOOK)
				...
				.end();
		kickback = new Animation("kickbackAnim", "oldguns:galil", AnimationType.MELEEHIT)
				...
				.end();
		getOutMag = new Animation("getOutMagAnim", "oldguns:galil", AnimationType.RELOAD)
				.startKeyframe(12, "easeInSine")
				.translate(parts[2], 0.0f, 0.0f, 0.0f)
				...
				.rotate(parts[1], 0.0f, 0.0f, 0.0f)
				.end();
		reloadNoMag = new Animation("reloadNoMagAnim", "oldguns:galil", AnimationType.RELOAD)
				...
				.rotate(parts[1], 0.0f, 0.0f, 0.0f)
				.end();
		reloadMagByMag = new Animation("reloadMagByMagAnim", "oldguns:galil", AnimationType.RELOAD)
				.startKeyframe(12, "easeInSine")
				.translate(parts[1], 0.0f, -0.19f, 0.5399998f)
				.translate(parts[7], 0.0f, 0.0f, 0.0f)
				.translate(parts[5], 0.5299998f, 0.0f, 0.0f)
	...
	public Vector3f getMuzzleFlashPosition() {
		return new Vector3f(-0.37f, 0.46f, -1.81f);
	}
