...
public class ReloadHandler {
	...
	public static void setMag(GunModel model, int maxAmmo, boolean mag, String bpath, ItemMag magItem) {
		...
		model.getModModel().setReconstruct();
	}
	...
	public static void doGetOutMag(GunModel model, String mag, int bullets) {
		...
		setBullets(0);
		setMag(model, 0, false, Constants.EMPTY, Constants.EMPTY);
	}
	...
	public static void doGetOutMag(GunModel model) {
		...
		ReloadHandler.setMag(model, 0, false, Constants.EMPTY, Constants.EMPTY);
	}
