...
public class CooldownRecoilHandler {
	...
	public void tick() {
		...
		if (!this.cooldowns.isEmpty()) {
			...
			while (iterator.hasNext()) {
				...
				LogUtils.getLogger().info("Item: " + Utils.getR(entry.getKey()).toString());
	...
	public float getRecoil(ItemStack stack) {
		return CooldownRecoilHandler.this.getCooldownPercent(stack.getItem(), 
