...
public class GunPartsGui extends ContainerScreen<GunPartsContainer> {
	...
	public GunPartsGui(GunPartsContainer p_i51105_1_, PlayerInventory p_i51105_2_, ITextComponent c) {
		super(p_i51105_1_, p_i51105_2_, new TranslationTextComponent("gui.oldguns.gun_parts_gui"));
	...
	protected void init() {
			...
			slots.add(new GunSlot(t, (i + 8) + (wg % cols) * 18, (j + 26) + (int) Math.floor(wg / cols) * 18, 178, 0,
				...
				public void onPress() {
					...
					for (int g2 = 0; g2 < matchingparts.size(); g2++) {
						...
						partSlots.add(new GunSlot(t2, (i + 8) + (wg2 % cols) * 18,
		...
		addButton(new Button(i + 61, j + 7, 178, 60, 26, 18, 26, GUNPARTS_GUI) {
			@Override
			public void onPress() {
				super.onPress();
		...
		addButton(new Button(i + 91, j + 7, 178, 40, 26, 18, 26, GUNPARTS_GUI) {
			@Override
			public void onPress() {
				super.onPress();
				if (gunLevel) {
		...
		addButton(new Button(i + 133, j + 63, 178, 20, 26, 18, 26, GUNPARTS_GUI) {
			@Override
			public void onPress() {
				super.onPress();
				/*
	...
	protected void renderBg(MatrixStack matrixStack, float p_230450_2_, int p_230450_3_, int p_230450_4_) {
		Minecraft.getInstance().textureManager.bind(GUNPARTS_GUI);
		int i = this.leftPos;
		int j = this.topPos;
