...
public class GunCraftingGui2 extends AbstractContainerScreen<GunCraftingTableContainer> {
	...
	public GunCraftingGui2(GunCraftingTableContainer p_i51105_1_, Inventory p_i51105_2_, Component c) {
			...
			for (int g = 0; g < size; g++) {
				...
				slots.add(new GunSlot(this, t, (i + 34) + (wg % 6) * 18, (j + 9) + (int) Math.floor(wg / 6) * 18, 177, 60,
					...
					public void onPress() {
						...
						GunCraftingGui2.this.model = Utils.getModel(this.gun.getItem());
