...
public class GunPartsScreen extends Screen {
	...
	public GunPartsScreen(GunModel gunModel) {
		super(Component.translatable("GunParts Screen"));
	...
	protected void init() {
		...
		//if(!init) {
			...
			buttons.add(new Button(342, 2, 30, 20, Component.translatable("Anim"), (b) -> {
			...
			// Buttons
			buttons.add(new Button(170, 2, 30, 20, Component.translatable("Copy"), (b) -> {
			...
			buttons.add(new Button(170, 24, 30, 20, Component.translatable("Paste"), (b) -> {
				List<Integer> indexes = gunPartList.getSelectedIndexes();
			...
			booleanCycles.add(buildBooleanCycle((s) -> {
				if(s) {
					return Component.translatable("Dis");
				} else {
					return Component.translatable("Tra");
				}
			}, false, 170, 46, 50, 20, 
				Component.translatable("Type"), (c, v) -> {
