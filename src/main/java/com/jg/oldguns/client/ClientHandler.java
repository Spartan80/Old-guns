...
public class ClientHandler {
	...
	public ClientHandler() {
		...
		muzzleFlashHandler = new MuzzleFlashHandler();
	}

	public void renderMuzzleFlash(PoseStack stack, BufferSource impl, float partialTicks, ItemStack istack) {
		if (gunmodel != null) {
			if(muzzleFlashHandler.canRenderMuzzleFlash()) {
				gunmodel.renderMuzzleFlash(stack, impl, partialTicks, istack);
			}
		}
	}
	...
	public void tryToReload(int gunbullets, int magbullets, int ammoindex, boolean hasMag) {
		gunmodel.reset(gunbullets, magbullets, ammoindex);
		gunmodel.initReloadAnimation(gunbullets, magbullets, hasMag);
	}
