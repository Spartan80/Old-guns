...
public class AmmoCraftingTableContainer extends AbstractContainerMenu {

	public AmmoCraftingTableContainer(int id, Inventory pi) {
		super(ContainerRegistries.GUN_AMMO_CONTAINER.get(), id);
	...
	public boolean stillValid(Player p_75145_1_) {
		return super.stillValid(ContainerLevelAccess.NULL, p_75145_1_, BlockRegistries.Gun_ammo_block.get());
	}
