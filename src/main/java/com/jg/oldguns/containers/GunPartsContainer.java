...
public class GunPartsContainer extends Container {

	public GunPartsContainer(int id, PlayerInventory pi) {
	...
	public boolean stillValid(PlayerEntity p_75145_1_) {
		return super.stillValid(IWorldPosCallable.NULL, p_75145_1_, BlockRegistries.Gun_parts_block.get());
	}
