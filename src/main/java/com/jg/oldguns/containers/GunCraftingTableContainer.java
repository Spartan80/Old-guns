...
public class GunCraftingTableContainer extends AbstractContainerMenu {

	public GunCraftingTableContainer(int id, Inventory inv) {
	...
	public boolean stillValid(Player p_75145_1_) {
		return super.stillValid(ContainerLevelAccess.NULL, p_75145_1_, BlockRegistries.Gun_crafting_block.get());
	}
