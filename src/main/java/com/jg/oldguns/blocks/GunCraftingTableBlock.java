...
public class GunCraftingTableBlock extends Block implements INamedContainerProvider {
	...
	public Container createMenu(int p_createMenu_1_, PlayerInventory p_createMenu_2_, PlayerEntity p_createMenu_3_) {
		return new GunCraftingTableContainer(p_createMenu_1_, p_createMenu_2_);
	}

	@Override
	public ITextComponent getDisplayName() {
		return new TranslationTextComponent("com.jg.container.gun_crafting_table_container");
	}
