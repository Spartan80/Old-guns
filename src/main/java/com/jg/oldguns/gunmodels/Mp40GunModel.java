...
public class Mp40GunModel extends GunModel {
	...
	public void setupAnimations() {
		...
		animator.startKeyframe(4);
		animator.move(rightarm, 0.13999999f, -0.11999998f, -0.06999999f);
		animator.move(gun, 0.0f, 0.28f, 0.0f);
		animator.move(hammer, 0.0f, 0.28f, 0.0f);
		animator.move(mag, 0.0f, 0.28f, 0.0f);
		animator.move(leftarm, -0.26000002f, 0.0f, 0.0f);
		...
		animator.endKeyframe();
		animator.startKeyframe(4);
		animator.move(rightarm, -0.36999992f, 0.050000012f, -0.04f);
		animator.move(gun, 0.0f, -0.21000004f, 0.0f);
		animator.move(hammer, 0.0f, -0.21000004f, 0.0f);
		animator.move(mag, 0.0f, -0.21000004f, 0.0f);
		animator.move(leftarm, -0.46999982f, -0.17f, 0.0f);
