...
import com.jg.oldguns.network.SetPartWeightMessage;
...
public class OldGuns {
	...
	public static final CreativeModeTab tab = new CreativeModeTab("OldGuns") {
	...
	private void setup(final FMLCommonSetupEvent event) {
		...
		channel.registerMessage(packetsRegistered++, InitMessage.class, InitMessage::encode, InitMessage::decode,
				InitMessage::handle);
		channel.registerMessage(packetsRegistered++, BodyHitMessage.class, BodyHitMessage::encode, BodyHitMessage::decode,
				BodyHitMessage::handle);
		channel.registerMessage(packetsRegistered++, SetPartWeightMessage.class, SetPartWeightMessage::encode, SetPartWeightMessage::decode,
				SetPartWeightMessage::handle);
	}
